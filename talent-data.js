...
//  - Grid position (tier/col) is simply a left-to-right, top-to-bottom fill
//    in the order talents are listed below -- it does NOT reflect the real
//    Forever tree layout, which the repo owner will correct by hand.
...
const TALENT_TREES = [
  {
    ...
    talents: [
      ...
      { key: 'improved-charge', name: 'Improved Charge', tier: 1, col: 4, maxRank: 2, icon: 'ability_warrior_charge', spellId: 12285, ranks: [
        'Increases the Rage generated by your Charge ability by 3.',
        'Increases the Rage generated by your Charge ability by 6.',
      ] },
      { key: 'improved-tactical-mastery', name: 'Improved Tactical Mastery', tier: 2, col: 1, maxRank: 5, icon: 'spell_nature_enchantarmor', spellId: 12295, ranks: [
      ...
      { key: 'improved-overpower', name: 'Improved Overpower', tier: 2, col: 2, maxRank: 2, icon: 'inv_sword_05', spellId: 12290, ranks: [
      ...
      { key: 'anger-management', name: 'Anger Management', tier: 2, col: 3, maxRank: 1, icon: 'spell_holy_blessingofstamina', spellId: 12296, requires: { key: 'improved-tactical-mastery', rank: 5 }, ranks: [
        'Generates 1 Rage every 3 sec while in combat, and reduces Rage loss while out of combat by 30%.',
      ] },
      { key: 'deep-wounds', name: 'Deep Wounds', tier: 2, col: 4, maxRank: 1, icon: 'ability_backstab', spellId: 12834, requires: { key: 'improved-rend', rank: 3 }, ranks: [
        "Your critical strikes cause your opponent to bleed, dealing 20% of your melee weapon's average damage over 12 sec.",
      ] },
      { key: 'searing-strike', name: 'Searing Strike', tier: 3, col: 1, maxRank: 1, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
      ...
      { key: 'two-handed-weapon-specialization', name: 'Two-Handed Weapon Specialization', tier: 3, col: 2, maxRank: 3, icon: 'inv_axe_09', spellId: 12163, ranks: [
      ...
      { key: 'impale', name: 'Impale', tier: 3, col: 3, maxRank: 2, icon: 'ability_searingarrow', spellId: 16493, requires: { key: 'deep-wounds', rank: 1 }, ranks: [
      ...
      { key: 'bloodthrill', name: 'Bloodthrill', tier: 3, col: 4, maxRank: 5, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
        ...
        'Your melee attacks against targets afflicted by your Rend have a 8% chance to activate your Overpower ability for 1 attack on your current target. Lasts 6 seconds.',
        'Your melee attacks against targets afflicted by your Rend have a 10% chance to activate your Overpower ability for 1 attack on your current target. Lasts 6 seconds.',
      ] },
      { key: 'sweeping-strikes', name: 'Sweeping Strikes', tier: 4, col: 1, maxRank: 1, icon: 'ability_rogue_slicedice', spellId: 12292, ranks: [
        '30 sec cooldown, Requires Battle Stance. Your next 5 melee attacks strike an additional nearby opponent.',
      ] },
      { key: 'weaponmaster', name: 'Weaponmaster', tier: 4, col: 2, maxRank: 5, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
        ...
        "Gives your melee weapon attacks a benefit depending on the weapon: Axe/Polearm: +4% critical strike chance. Mace/Staff: attacks ignore 12% of your target's armor. Sword: 4% chance to trigger an extra attack on the target.",
        "Gives your melee weapon attacks a benefit depending on the weapon: Axe/Polearm: +5% critical strike chance. Mace/Staff: attacks ignore 15% of your target's armor. Sword: 5% chance to trigger an extra attack on the target.",
      ] },
      { key: 'improved-slam', name: 'Improved Slam', tier: 5, col: 1, maxRank: 2, icon: 'ability_warrior_decisivestrike', spellId: 12862, ranks: [
      ...
      { key: 'improved-hamstring', name: 'Improved Hamstring', tier: 5, col: 2, maxRank: 3, icon: 'ability_shockwave', spellId: 12289, ranks: [
      ...
      { key: 'mortal-strike', name: 'Mortal Strike', tier: 5, col: 3, maxRank: 1, icon: 'ability_warrior_savageblow', spellId: 12294, requires: { key: 'sweeping-strikes', rank: 1 }, ranks: [
  ...
  },
  {
    ...
    talents: [
      ...
      { key: 'death-wish', name: 'Death Wish', tier: 3, col: 4, maxRank: 1, icon: 'spell_shadow_deathpact', spellId: 12328, ranks: [
      ...
      { key: 'improved-intercept', name: 'Improved Intercept', tier: 4, col: 1, maxRank: 2, icon: 'ability_rogue_sprint', spellId: 20504, ranks: [
        'Reduces the cooldown of your Intercept ability by 5 sec.',
        'Reduces the cooldown of your Intercept ability by 10 sec.',
      ] },
      { key: 'improved-berserker-rage', name: 'Improved Berserker Rage', tier: 4, col: 2, maxRank: 2, icon: 'spell_nature_ancestralguardian', spellId: 20500, ranks: [
      ...
      { key: 'iron-will', name: 'Iron Will', tier: 4, col: 3, maxRank: 5, icon: 'spell_magic_magearmor', spellId: 12300, ranks: [
      ...
      { key: 'boundless-rage', name: 'Boundless Rage', tier: 4, col: 4, maxRank: 3, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
        'Increases your maximum Rage by 10.',
        'Increases your maximum Rage by 20.',
        'Increases your maximum Rage by 30.',
      ] },
      { key: 'flurry', name: 'Flurry', tier: 5, col: 1, maxRank: 5, icon: 'ability_ghoulfrenzy', spellId: 12319, requires: { key: 'enrage', rank: 5 }, ranks: [
      ...
      { key: 'raging-blows', name: 'Raging Blows', tier: 5, col: 2, maxRank: 1, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
        'Causes your Whirlwind to also strike with your off-hand weapon, and reduces the Rage cost of your Cleave ability by 2.',
      ] },
      { key: 'precision', name: 'Precision', tier: 5, col: 3, maxRank: 3, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
      ...
      { key: 'bloodthirst', name: 'Bloodthirst', tier: 5, col: 4, maxRank: 1, icon: 'spell_nature_bloodlust', spellId: 23881, requires: { key: 'death-wish', rank: 1 }, ranks: [
  ...
  },
  {
    ...
    icon: 'inv_shield_06',
    talents: [
      { key: 'shield-specialization', name: 'Shield Specialization', tier: 1, col: 1, maxRank: 5, icon: 'inv_shield_06', spellId: 12298, ranks: [
        'Increases your chance to Block attacks with a shield by 1% and grants you a 20% chance to generate 5 Rage when you Block.',
        'Increases your chance to Block attacks with a shield by 2% and grants you a 40% chance to generate 5 Rage when you Block.',
        'Increases your chance to Block attacks with a shield by 3% and grants you a 60% chance to generate 5 Rage when you Block.',
        'Increases your chance to Block attacks with a shield by 4% and grants you a 80% chance to generate 5 Rage when you Block.',
        'Increases your chance to Block attacks with a shield by 5% and grants you a 100% chance to generate 5 Rage when you Block.',
      ] },
      { key: 'anticipation', name: 'Anticipation', tier: 1, col: 2, maxRank: 5, icon: 'spell_nature_mirrorimage', spellId: 12297, ranks: [
      ...
      { key: 'improved-bloodrage', name: 'Improved Bloodrage', tier: 1, col: 3, maxRank: 3, icon: 'ability_racial_bloodrage', spellId: 12301, ranks: [
        'Increases the Rage generated by your Bloodrage ability by 15%.',
        'Increases the Rage generated by your Bloodrage ability by 30%.',
        'Increases the Rage generated by your Bloodrage ability by 45%.',
      ] },
      { key: 'toughness', name: 'Toughness', tier: 1, col: 4, maxRank: 5, icon: 'spell_holy_devotion', spellId: 12299, ranks: [
      ...
      { key: 'improved-thunder-clap', name: 'Improved Thunder Clap', tier: 2, col: 1, maxRank: 3, icon: 'ability_thunderclap', spellId: 12287, ranks: [
        'Reduces the cost of your Thunder Clap ability by 2 Rage.',
        'Reduces the cost of your Thunder Clap ability by 4 Rage.',
        'Reduces the cost of your Thunder Clap ability by 6 Rage.',
      ] },
      { key: 'last-stand', name: 'Last Stand', tier: 2, col: 2, maxRank: 1, icon: 'spell_holy_ashestoashes', spellId: 12975, requires: { key: 'improved-bloodrage', rank: 2 }, ranks: [
      ...
      { key: 'improved-shield-block', name: 'Improved Shield Block', tier: 2, col: 3, maxRank: 3, icon: 'ability_defend', spellId: 12945, requires: { key: 'shield-specialization', rank: 5 }, ranks: [
      ...
      { key: 'improved-revenge', name: 'Improved Revenge', tier: 2, col: 4, maxRank: 3, icon: 'ability_warrior_revenge', spellId: 12797, ranks: [
      ...
      { key: 'defiance', name: 'Defiance', tier: 3, col: 1, maxRank: 3, icon: 'ability_warrior_innerrage', spellId: 12303, ranks: [
      ...
      { key: 'improved-sunder-armor', name: 'Improved Sunder Armor', tier: 3, col: 2, maxRank: 3, icon: 'ability_warrior_sunder', spellId: 12308, ranks: [
        'Reduces the cost of your Sunder Armor ability by 1 Rage.',
        'Reduces the cost of your Sunder Armor ability by 2 Rage.',
        'Reduces the cost of your Sunder Armor ability by 3 Rage.',
      ] },
      { key: 'improved-disarm', name: 'Improved Disarm', tier: 3, col: 3, maxRank: 3, icon: 'ability_warrior_disarm', spellId: 12313, ranks: [
      ...
      { key: 'improved-taunt', name: 'Improved Taunt', tier: 3, col: 4, maxRank: 2, icon: 'spell_nature_reincarnation', spellId: 12302, ranks: [
        'Reduces the cooldown of your Taunt ability by 1 sec.',
        'Reduces the cooldown of your Taunt ability by 2 sec.',
      ] },
      { key: 'improved-shield-wall', name: 'Improved Shield Wall', tier: 4, col: 1, maxRank: 2, icon: 'ability_warrior_shieldwall', spellId: 12312, ranks: [
        'Reduces the cooldown of your Shield Wall ability by 5.5 min.',
        'Reduces the cooldown of your Shield Wall ability by 11 min.',
      ] },
      { key: 'concussion-blow', name: 'Concussion Blow', tier: 4, col: 2, maxRank: 1, icon: 'ability_thunderbolt', spellId: 12809, ranks: [
        '10 Rage, Melee Range, 45 sec cooldown, Instant. Stuns the target for 5 sec.',
      ] },
      { key: 'improved-shield-bash', name: 'Improved Shield Bash', tier: 4, col: 3, maxRank: 2, icon: 'ability_warrior_shieldbash', spellId: 12311, ranks: [
      ...
      { key: 'one-handed-weapon-specialization', name: 'One-Handed Weapon Specialization', tier: 4, col: 4, maxRank: 5, icon: 'inv_sword_20', spellId: 16538, ranks: [
      ...
      { key: 'shield-slam', name: 'Shield Slam', tier: 5, col: 1, maxRank: 1, icon: 'inv_shield_05', spellId: 23922, requires: { key: 'concussion-blow', rank: 1 }, ranks: [
      ...
      { key: 'master-of-defense', name: 'Master of Defense', tier: 5, col: 2, maxRank: 2, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
      ...
      { key: 'vanguard', name: 'Vanguard', tier: 5, col: 3, maxRank: 1, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
      ...
      { key: 'bastion', name: 'Bastion', tier: 6, col: 2, maxRank: 5, icon: PLACEHOLDER_ICON, spellId: null, ranks: [
        ...
        'Reduces all damage you take by 8% while a shield is equipped.',
        'Reduces all damage you take by 10% while a shield is equipped.',
      ] },
    ],
  },
];
